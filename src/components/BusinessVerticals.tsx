...
const BusinessVerticals: React.FC = () => {
  ...
  const businesses = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1611365892117-00d03937791b?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1584277261846-c6a1672ed979?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80",
          ...
          <div className="lg:col-span-3">
            <div className="bg-gray-50 rounded-xl p-4 sticky top-20">
              {businesses.map((business) => (
                <button
                  key={business.id}
                  className={`w-full flex items-center p-4 rounded-lg mb-2 transition-all ${
