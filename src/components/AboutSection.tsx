...
const AboutSection: React.FC = () => {
  ...
  return <section className="py-20 bg-genedge-light-gray">
          ...
          <div className="order-2 lg:order-1">
            <div className="relative">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <img src="https://images.unsplash.com/photo-1593561011103-5ac1057fd0f4?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="Solar panels" className="rounded-lg shadow-lg w-full h-64 object-cover mb-4" />
                ...
                <div className="mt-8">
                  ...
                  <img src="https://images.unsplash.com/photo-1579962404986-56bb6647ba41?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="Battery storage" className="rounded-lg shadow-lg w-full h-64 object-cover" />
                </div>
              </div>
